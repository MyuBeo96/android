...
public class TabMenuLevelThirdItem_2 extends TabItem {
	MenuItemAction action;

	public TabMenuLevelThirdItem_2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void initView(Context context) {
		...
		inflater.inflate(R.layout.tabmenulevelthird_item_2, this);
	}
